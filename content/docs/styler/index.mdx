...
h(Alert, { variant: 'error' }, "Something went wrong")
h(Alert, { variant: 'success' }, "Operation completed")
```
...
h(Text, { as: 'p' }, "Paragraph text")

// Renders as an <h1>
h(Text, { as: 'h1' }, "Heading text")

// Renders as a <label>
h(Text, { as: 'label' }, "Label text")
```
...
h(Box, { class: 'custom-class' })
// class="ns-abc123 custom-class"

h(Box, { className: 'react-style' })
...
// Single child
h(Wrapper, null, "Hello")

// Multiple children
h(Wrapper, null, h('span', null, 'A'), h('span', null, 'B'))

// Array children
h(Wrapper, { children: ['a', 'b', 'c'] })
```
...
// Usage
h(Button, { variant: 'primary', size: 'lg' }, "Submit")
h(Button, { variant: 'outline' }, "Cancel")
h(Button, { variant: 'danger', size: 'sm' }, "Delete")
```
...
// Usage
h(Card, null,
  h(CardHeader, null, "Card Title"),
  h(CardBody, null, "Card content goes here..."),
  h(CardFooter, null,
    h(Button, { variant: 'outline' }, "Cancel"),
