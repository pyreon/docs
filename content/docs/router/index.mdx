...
<APICard name="buildPath" type="function" signature="buildPath(pattern: string, params: Record<string, string>): string" description="Build a path string from a route pattern and params, encoding param values." />
